...
// GetWxTicket 获取授权页ticket
func (w *Wechat) GetWxTicket() WxTicket {
	url := "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=" + w.AccessToken() + "&type=jsapi"
	ticketStr := CurlGET(url)
	...
	if err != nil {
		...
		fmt.Println("GetWxTicket==", ticket)
	}
	return ticket
}
